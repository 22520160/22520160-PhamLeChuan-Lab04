...
namespace Lab04
{
    public partial class Bai07 : Form
    {
        ...
        private int count = 0;
        public Bai07(string tokentype, string accesstoken)
        {
            InitializeComponent();
        ...
        private void Addprogressbar(string monan, string gia, string diachi, string nguoidonggop, PictureBox pictureBox)
        {
            ...
            // Đảm bảo rằng bạn chỉ thêm một UserControl vào FlowLayoutPanel
            if (hienthi is Control)
            {
                flowLayoutPanel1.Controls.Add(hienthi);
            }
            else
            {
                throw new InvalidOperationException("Hienthimonan is not a valid control.");
            }
        }
        public class MonAn
        {
